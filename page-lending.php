...
<section class="catalog">
      <div class="container">
        <div class="catalog_items grid">
          <div class="item item-img grid">
            <img src="images/Thuja1.png" alt=" " />
          </div>
          <div class="item_list item grid">
          ...
          <div class="item item-img grid">
            <img src="images/Thuja2.png" alt=" " />
          </div>

          <div class="item item-img grid">
            <img src="images/Thuja3.png" alt=" " />
          </div>
          <div class="item_list item grid">
    ...
    <section class="catalog_two container landing-section">
      <div class="container">
        ...
        <div class="catalog_cards">
          <div class="products__item">
            <div class="products__image">
              <img src="images/smaragd.png" alt="" />
            </div>
            ...
            <button class="button-small">Замовити</button>
          </div>
          <div class="products__item">
            <div class="products__image">
              <img src="images/samshit.png" alt="" />
            </div>
            <div class="products__name">
              <p>
          ...
          <div class="products__item">
            <div class="products__image">
              <img src="images/Thuja11.png" alt="" />
            </div>
            <div class="products__name">
              <p>
      ...
      <div class="container">
        ...
        <div class="reviews_items grid">
          <div class="reviews_item grid">
            <h2>Анастасія<img src="images/ico.svg" alt="" /></h2>
            <p>
          ...
          <div class="reviews_item grid">
            <h2>Наталля<img src="images/ico.svg" alt="" /></h2>
          ...
          <div class="reviews_item grid">
            <h2>Юля<img src="images/ico.svg" alt="" /></h2>

            <p>Туї якісні. Відповідають опису. Швидко відправили.</p>
          </div>
          <div class="reviews_item grid">
            <h2>Сергій<img src="images/ico.svg" alt="" /></h2>
      ...
      <div class="container">
                    ...
                    <div class="col-md-12 items-right cards-about-shop">
                        <div class="forms">
                            ...
                            <?php echo do_shortcode( '  [contact-form-7 id="532" title="mics"] ') ?>
                        </div>
      ...
      <div class="container">
        <div class="footer_items grid">
          <div class="my_logo grid>
            <a href="#">
              <img src="images/Logos.svg" class=" img-responsive" alt=""
            />
          </a>
          </div>
        <div class="menus_items">
          <a href="" class="items_menu">Головна</a>
          <a href="" class="items_menu">Прайс</a>
          <a href="" class="items_menu">Про мене</a>
          <a href="" class="items_menu">Зв'язок</a>
        </div>
        <div class="tels grid">
          <div class="tel_top">
            <a href="tel:+380986893612">
              <img src="images/tel 1.svg" alt="" /> 098-689-36-12
            </a>
          </div>
          <p>Олександр</p>
